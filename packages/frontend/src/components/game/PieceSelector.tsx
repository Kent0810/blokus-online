...
function PieceMini({ pieceId, color, used, selected, onClick }: {
  pieceId: string;
  color: string;
  used: boolean;
  selected: boolean;
    ...
    <div className="flex flex-col gap-3">
      ...
      <div className="flex gap-2">
        <button
          ...
          className="flex-1 flex items-center justify-center gap-1 text-xs font-medium text-slate-300 hover:text-white bg-surface-2 hover:bg-slate-600 disabled:opacity-30 disabled:cursor-not-allowed rounded-lg py-2 transition-all duration-150"
          title="Rotate (R)"
        >
